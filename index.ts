...
async function fetchResponseToExpress(res: express.Response, response: Response) {
  ...
  for (const file of files) {
    ...
    for (const method of ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS']) {
      if (typeof mod[method] === 'function') {
        (app as any)[method.toLowerCase()](route, async (req: express.Request, res: express.Response) => {
          try {
